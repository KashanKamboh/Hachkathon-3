...
const SignIn=()=>{
    return(
       ...
       {/* <div className="background-image: url(https://readymadeui.com/background-image.webp); background-repeat: no-repeat; background-size: cover;"
      ...
      <div className="max-w-md w-full mx-auto">
        <form className="bg-opacity-70 bg-white rounded p-6 shadow-[0_2px_16px_-3px_rgba(125,126,131,0.3)]">
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-800 text-sm text-center mt-6">Don't have an account <a href="javascript:void(0);"
